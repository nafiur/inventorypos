...
@section('content')
@section('title')
{{ 'Show Product Category Information' }}
@endsection
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Show Product Category Information</h6>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Product Category Information</h5>
            </div>
            <div class="card-body">
