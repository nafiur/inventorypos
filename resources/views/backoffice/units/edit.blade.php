...
<div class="dashboard-main-body">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Update Unit Information</h6>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row gy-3 needs-validation" action="{{ route('unit.update') }}" method="POST" novalidate>
                    @csrf
                    <input type="hidden" name="id" value="{{ $unit->id }}" id="">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-6">
                ...
                <iconify-icon icon="f7:person"></iconify-icon>
                                    ...
                                    <input type="text" name="name" value="{{ $unit->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Name" required>
                                    @error('name')
