...
<div class="dashboard-main-body">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Show Customer Information</h6>
        <ul class="d-flex align-items-center gap-2">
            ...
            <li>-</li>
            <li class="fw-medium"><a href="{{ route('customer.index') }}" class="hover-text-primary">Supplier List</a></li>
        </ul>
    </div>
    <div class="col-lg-12">
        <div class="card">
                                        ...
                                        <div>
                                            ...
                                            <table class=" text-secondary-light">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Address</td>
                                                        <td class="ps-8">: {{ $customer->address ??'' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Phone number</td>
                                                        <td class="ps-8">: {{ $customer->mobile_no ??'' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email</td>
